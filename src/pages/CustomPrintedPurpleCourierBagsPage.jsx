...
const sizes = ["6.5x8", "8x10", "10x12", "10x14", "12x16", "12x14", "14x16"];
...
export default function CustomPrintedPurpleCourierBagsPage() {
  const cart = useCart();
  const auth = useAuth();
  ...
  const range = useMemo(() => ({ min: 818, max: 4872 }), []);
  ...
  const sku = useMemo(() => {
    ...
    return `Purple-Printed-${size}-${pc}-${pk}-${qtyPack}`.replaceAll(".", "_");
  }, [pocket, printColor, qtyPack, size]);

  const images = useMemo(() => [purpleBag, purpleBag, purpleBag, purpleBag, purpleBag], []);
  ...
  const product = useMemo(
    () => ({
      id: "custom-purple-courier-60",
      title: "Custom Printed Purple Courier Bags – 60 micron",
      image: purpleBag,
      price: computedPrice,
  ...
  return (
    <section className="productPage" aria-label="Custom printed purple courier bags detail">
      <div className="container">
        <div className="breadcrumb" aria-label="Breadcrumb">
          ...
          <span className="breadcrumb__sep">/</span>
          <span className="breadcrumb__item">Custom Printed Purple Bag</span>
          <span className="breadcrumb__sep">/</span>
          <span className="breadcrumb__item breadcrumb__item--active">Custom Printed Purple Courier Bags – 60 Micron</span>
        </div>
        ...
        <div className="pdGrid">
          <div className="pdLeft">
            <div className="pdMedia" aria-label="Product image preview">
              ...
              <img className="pdImg" src={images[activeImg]} alt="Custom printed purple courier bag" />
            </div>
          ...
          <div className="pdRight">
            <h1 className="pdTitle">Custom Printed Purple Courier Bags – 60 micron</h1>
            ...
            <div className="pdRating">
              ...
              <a className="pdReviewsLink" href="#" aria-label="13 customer reviews" onClick={(e) => e.preventDefault()}>
                (13 Customer Reviews)
              </a>
            </div>
            ...
            <div className="pdMeta" aria-label="Product information">
              ...
              <div className="pdMetaRow">
                ...
                <span className="pdMetaVal">
                  ...
                  {", "}
                  <span className="inlineLink">Custom Printed Purple Bag</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="pdTabs" aria-label="Product information tabs">
          <div className="pdTabList" role="tablist" aria-label="Tabs">
            {["Description", "Additional Information", "Reviews (13)"].map((t) => (
              <button
                key={t}
        ...
        <section className="relatedSection" aria-label="Related products">
          ...
          <div className="relatedGrid">
            <RelatedCard title="Custom Printed Pink Courier Bags – 60 micron" image={pinkBag} />
        ...
        <dialog ref={dialogRef} className="zoomDialog" aria-label="Image zoom">
          <div className="zoomDialog__inner">
            ...
            <img className="zoomImg" src={images[activeImg]} alt="Custom printed purple courier bag zoomed" />
          </div>
        </dialog>
      </div>
    </section>
    ...
    <article className="productCard">
      ...
      <div className="productCard__body">
        ...
        <div className="priceRow" aria-label="Price">
          ...
          <span className="priceRow__price">₹4,872.00</span>
        </div>
