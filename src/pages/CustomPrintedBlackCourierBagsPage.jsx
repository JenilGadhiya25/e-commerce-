...
const sizes = ["6.5x8", "8x10", "10x12", "10x14", "12x16", "14x16", "14x18", "16x20"];
...
export default function CustomPrintedBlackCourierBagsPage() {
  const cart = useCart();
  const auth = useAuth();
  ...
  const range = useMemo(() => ({ min: 810, max: 6173 }), []);
  ...
  const sku = useMemo(() => {
    ...
    return `Black-Printed-${size}-${pc}-${pk}-${qtyPack}`.replaceAll(".", "_");
  }, [pocket, printColor, qtyPack, size]);

  const images = useMemo(() => [blackBag, blackBag, blackBag, blackBag, blackBag], []);
  ...
  const product = useMemo(
    () => ({
      id: "custom-black-courier-60",
      title: "Custom Printed Black Courier Covers – 60 Micron",
      image: blackBag,
      price: computedPrice,
  ...
  return (
    <section className="productPage" aria-label="Custom printed black courier bags detail">
      <div className="container">
        <div className="breadcrumb" aria-label="Breadcrumb">
          ...
          <span className="breadcrumb__sep">/</span>
          <span className="breadcrumb__item">Custom Printed Black Courier Bag</span>
          <span className="breadcrumb__sep">/</span>
          <span className="breadcrumb__item breadcrumb__item--active">Custom Printed Black Courier Covers – 60 Micron</span>
        </div>
        ...
        <div className="pdGrid">
          <div className="pdLeft">
            <div className="pdMedia" aria-label="Product image preview">
              ...
              <img className="pdImg" src={images[activeImg]} alt="Custom printed black courier cover" />
            </div>
          ...
          <div className="pdRight">
            <h1 className="pdTitle">Custom Printed Black Courier Covers – 60 Micron</h1>
            ...
            <div className="pdRating">
              ...
              <a className="pdReviewsLink" href="#" aria-label="21 customer reviews" onClick={(e) => e.preventDefault()}>
                (21 Customer Reviews)
              </a>
            </div>
            ...
            <div className="pdMeta" aria-label="Product information">
              ...
              <div className="pdMetaRow">
                ...
                <span className="pdMetaVal">
                  ...
                  {", "}
                  <span className="inlineLink">Custom Printed Black Courier Bag</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="pdTabs" aria-label="Product information tabs">
          <div className="pdTabList" role="tablist" aria-label="Tabs">
            {["Description", "Additional Information", "Reviews (21)"].map((t) => (
              <button
                key={t}
        ...
        <section className="relatedSection" aria-label="Related products">
          ...
          <div className="relatedGrid">
            ...
            <RelatedCard title="Custom Printed White Courier Bags – 51 micron" image={whiteBag} href="/product/custom-printed-white-courier-bags-51-micron" />
          </div>
        </section>
        ...
        <dialog ref={dialogRef} className="zoomDialog" aria-label="Image zoom">
          <div className="zoomDialog__inner">
            ...
            <img className="zoomImg" src={images[activeImg]} alt="Custom printed black courier cover zoomed" />
          </div>
        </dialog>
      </div>
    </section>
    ...
    <article className="productCard">
      ...
      <div className="productCard__body">
        ...
        <div className="priceRow" aria-label="Price">
          <span className="priceRow__original">₹810.00</span>
          <span className="priceRow__price">₹6,173.00</span>
        </div>
        {href ? (
